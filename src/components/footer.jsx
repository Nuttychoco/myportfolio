...
export const Footer = () => {
    return (
        <footer className='footer'>
            ...
            <p className='centerText'>Tech used:  <img src={iconR} alt="" className='footerLogo' /> <img src={iconJ} alt="" className='footerLogo' /> <img src={iconCss} alt="" className='footerLogo' /></p>
